...
autorest -Input http://localhost:5000/swagger/v1/swagger.json -CodeGenerator CSharp -OutputDirectory ./client/Lykke.Service.BitcoinCash.Client/AutorestClient -namespace Lykke.Service.BitcoinCash.Sign.Client.AutorestClient
